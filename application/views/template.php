                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        ?>
                                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/uploadtemplate/proses">
                                            <div>Berkas : </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a type="button" data-toggle="modal" href="<?php echo base_url(); ?>index.php/upload/download/<?php echo $row->kd_berkas; ?>" class="btn btn-success">Download</a>
                                    </td>
